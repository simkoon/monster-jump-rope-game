...
- [ ] 02-01: 시작/설정 흐름 (개인전·팀전 선택, 인원·이름·캐릭터 배정, 게임 시작, 미션 목록 비어있음 안내)
- [ ] 02-02: 헤드리스 게임 엔진 (턴 FSM, 가중치 뽑기, 주사위, 이동, 확률 기반 이벤트 배치·적용, 승리 판정) + 분포 테스트 포함 격리 RNG 모듈
- [ ] 02-03: 루프를 끝까지 연결하는 플레인 DOM 하네스 (카드 뽑기·성공/실패·주사위·위치·이벤트·결과·재시작)
